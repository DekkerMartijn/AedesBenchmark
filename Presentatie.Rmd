...
Jaarlijkse vergelijking van de maatschappelijke prestaties van van ca 300 corporaties over 5 prestatievelden. Per prestatieveld o.b.v. een aantal bepalende variabelen een eindoordeel (A,B,C score). 
...
```{r HO16, echo=TRUE, message=FALSE, warning=FALSE, out.width = '100%', fig.align='center'}
### <b> 
