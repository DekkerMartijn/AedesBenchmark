...
Prestaties van van ca 300 corporaties over 5 prestatievelden met elkaar vergeleken. Per prestatieveld wordt o.b.v. een aantal bepalende variabelen een eindoordeel toegekend in de vorm van A,B,C score. 
...
## Fit with different vars {data-background=Background.png data-background-size=cover}
