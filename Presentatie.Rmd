...
## Conclusies {.build .smaller data-background=Background.png data-background-size=cover}

- Exacte werking Beoordelingskader
- Vervolg onderzoek inlvoed van overige kenmerken
- Andere technieken?
- Suggesties
